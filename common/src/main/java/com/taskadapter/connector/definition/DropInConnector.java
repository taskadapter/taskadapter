...
public interface DropInConnector extends FileBasedConnector, NewConnector {
     ...
     * @param monitor can't be null. See [[ProgressMonitorUtils]] if you don't want any monitoring.
     */
    List<GTask> loadDropInData(File file, ProgressMonitor monitor) throws ConnectorException;
}
