...
public class DefaultMSPMappings {
    public static Mappings generate() {
        ...
        result.setMapping(GTaskDescriptor.FIELD.SUMMARY, true, TaskField.SUMMARY.getName());
        ...
        result.setMapping(GTaskDescriptor.FIELD.DONE_RATIO, true, TaskField.PERCENT_COMPLETE.getName());
        result.setMapping(GTaskDescriptor.FIELD.ASSIGNEE, true, TaskField.ASSIGNMENT_OWNER.getName());
        result.setMapping(GTaskDescriptor.FIELD.DESCRIPTION, true, TaskField.NOTES.getName());
