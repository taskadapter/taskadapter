...
public class LicenseTextGenerator {
    ...
    public String generateLicenseText() {
        String text = license.getType().toString() + license.getCustomerName() + license.getEmail() + license.getCreatedOn() + license.getExpiresOn();
        ...
        StringBuilder licenseText = new StringBuilder()
                ...
                .append(LINE_DELIMITER).append(PREFIX_EXPIRES_ON).append(license.getExpiresOn())
