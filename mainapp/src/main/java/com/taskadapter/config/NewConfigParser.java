...
public final class NewConfigParser {
    ...
    static String toFileContent(String configName,
                                String connector1Id, String connector1SavedSetupIdString, String connector1Data,
                                String connector2Id, String connector2SavedSetupIdString, String connector2Data,
                                String mappings) {
        final StringBuilder result = new StringBuilder();
        result.append(NAME_PREFIX).append(configName).append("\n");
        result.append(CONN1_ID_PREFIX).append(connector1Id).append("\n");
        result.append(CONN1_SAVED_SETUP_ID).append(connector1SavedSetupIdString).append("\n");
        result.append(CONN1_DATA_PREFIX).append(connector1Data).append("\n");
        result.append(CONN2_ID_PREFIX).append(connector2Id).append("\n");
        result.append(CONN2_SAVED_SETUP_ID).append(connector2SavedSetupIdString).append("\n");
