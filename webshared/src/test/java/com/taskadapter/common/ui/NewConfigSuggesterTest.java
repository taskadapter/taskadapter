...
public class NewConfigSuggesterTest {
    ...
    private static final FieldMapping descriptionM = new FieldMapping(AllFields.description,
            AllFields.description, true, null);
    private static final FieldMapping dueDateM = new FieldMapping(AllFields.dueDate,
            AllFields.dueDate, true, null);
