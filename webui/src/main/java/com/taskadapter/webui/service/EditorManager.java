...
public class EditorManager {
    ...
    public <C extends ConnectorConfig, S extends ConnectorSetup> PluginEditorFactory<C,S> getEditorFactory(String connectorId) {
        final String realId = LegacyConnectorsSupport.getRealId(connectorId);
        return (PluginEditorFactory<C, S>) factories.get(realId);
    }
    ...
    private static EditorManager fromConfig(String config) {
    ...
    private static EditorManager fromImplementationMap(Map<String, String> implementations) {
