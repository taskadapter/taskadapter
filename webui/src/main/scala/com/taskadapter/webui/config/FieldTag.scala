...
import com.taskadapter.model.{Assignee, Components, DefaultValueResolver, Field, GUser, Reporter}

object FieldTag {
  val gson = ConfigUtils.createDefaultGson

  val tags: Map[Field[_], FieldTag[_]] = Map(Assignee -> new GUserTag(Assignee),
