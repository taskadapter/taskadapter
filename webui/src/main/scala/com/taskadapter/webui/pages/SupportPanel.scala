...
import com.taskadapter.webui.{EventTracker, LastVersionLoader, VersionComparator}
...
class SupportPanel(currentTaskAdapterVersion: String, licenseManager: LicenseFacade,
